...
from retinanet.dataloader import (AspectRatioBasedSampler, Augmenter,
                                  ...
                                  ReceiptDataset, Resizer, collater)
...
def main(args=None):
    ...
    parser.add_argument('--coco_path', help='Path to COCO directory', default='data/receipt_0158_0062')
    ...
    if parser.dataset == 'receipt':
        dataset_train = ReceiptDataset(parser.coco_path, set_name='train',
    ...
    if dataset_val is not None:
        ...
        dataloader_val = DataLoader(dataset_val, num_workers=4, collate_fn=collater, batch_sampler=sampler_val)  # noqa
    ...
    for epoch_num in range(parser.epochs):
        ...
        if parser.dataset == 'coco':
            ...
            mAP = csv_eval.evaluate(dataset_val, retinanet)  # noqa
